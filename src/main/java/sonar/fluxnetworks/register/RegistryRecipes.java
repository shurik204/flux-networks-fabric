...
public class RegistryRecipes {
    ...
    public static final FluxStorageRecipeSerializer FLUX_STORAGE_RECIPE = register(FLUX_STORAGE_RECIPE_KEY, FluxStorageRecipeSerializer.INSTANCE);
    public static final NBTWipeRecipeSerializer NBT_WIPE_RECIPE = register(NBT_WIPE_RECIPE_KEY, NBTWipeRecipeSerializer.INSTANCE);
